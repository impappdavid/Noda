          ...
          <div className="flex-1 overflow-y-auto scrollbar-hide">
            ...
            {invitations.length > 0 && (
              <section className="w-full border-b border-zinc-300">
                <div className="p-2 flex items-center justify-between bg-zinc-50/50 border-b border-zinc-300">
                  ...
                  <span className="text-[9px] font-mono font-black text-blue-600 uppercase tracking-tighter animate-pulse">
                    Action_Required
                  </span>
                </div>
            ...
            <section className="w-full">
              <div className="p-2 border-b flex items-center border-zinc-300 bg-zinc-50/40 w-full justify-between">
                ...
                <span className="text-[9px] font-mono font-black uppercase tracking-widest text-zinc-500 hover:text-blue-600 hover:underline cursor-pointer">
                  [view all]
                </span>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-3 ">
                {networkData.map((person: any) => (
