...
import {
    ...
    Users,  AlertTriangle, Briefcase, Globe, Calendar, DollarSign, CheckCircle2, Clock, Rss, X, CornerDownRight
} from 'lucide-react';
            ...
            <div className="flex flex-1 w-full max-w-4xl mx-auto overflow-hidden">
                ...
                <main className="flex flex-1 flex-col max-w-3xl border-x border-zinc-300 h-full bg-white overflow-hidden">
                    ...
                    <div className="flex w-full items-center border-b border-zinc-300 bg-white sticky top-0 z-30 h-10 divide-x divide-zinc-300">
                        <div className="relative flex-1 flex items-center bg-white px-3 h-full">
