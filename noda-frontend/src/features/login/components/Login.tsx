        ...
        >
            ...
            <div className="bg-white p-2 space-y-1 border-b border-zinc-300 focus-within:bg-zinc-50 transition-colors">
                <div className="flex justify-between items-center">
                    ...
                    <button type="button" tabIndex={-1} className="text-[9px] font-mono font-bold text-zinc-500 hover:text-blue-500 hover:underline cursor-pointer uppercase outline-none transition-colors leading-none">
                        Forgot?
                    </button>
                </div>
                <div className="relative flex items-center h-6">
            ...
            {/* Session Config */}
            <div className="bg-white p-2 col-span-2 flex items-center border-b border-zinc-300">
