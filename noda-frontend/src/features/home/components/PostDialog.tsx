                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-bold text-zinc-900 hover:underline">
              ...
              <div className="w-full h-10 flex border-y border-zinc-300">
                <div className="flex gap-1 w-full">
                  ...
                  <input
                    ...
                    className="rounded-none outline-none w-full px-2 text-xs"
                  />
                </div>

                <button className="bg-zinc-800 hover:bg-zinc-900 transition-colors px-3 pl-4 text-white text-xs cursor-pointer uppercase font-mono">
                  Post
                </button>
              </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="flex gap-4 mt-2">
                        <button className="text-[11px] font-mono text-zinc-500 hover:text-pink-600 cursor-pointer transition-colors flex items-center gap-1">
                          <Heart size={14} /> 320
                        </button>

                        <button className="text-[11px] font-mono text-zinc-500 hover:text-zinc-900 cursor-pointer transition-colors flex items-center gap-1">
