...
import { Eye, EyeOff, Mail, Lock, CircleAlert, User, AtSign} from "lucide-react"
...
const SignUpForm = ({ onLoginInitiated }: LoginPageProps) => {
        ...
        <div className="min-h-screen bg-zinc-50 flex md:items-center justify-center p-2 md:p-4 font-sans selection:bg-zinc-300">
            ...
            <div className="w-full max-w-lg flex flex-col">
                ...
                >
                    ...
                    <div className="bg-white p-2 space-y-1 col-span-2 border-r border-b border-zinc-300 focus-within:bg-zinc-50 transition-colors">
                        <label className="text-[9px] font-mono font-black text-zinc-500 uppercase tracking-widest block leading-none">
                            Email
                        </label>
                        <div className="relative flex items-center h-6">
                    ...
                    <div className="bg-white p-2 space-y-1 border-b border-r border-zinc-300 focus-within:bg-zinc-50 transition-colors">
                    ...
                    <div className="bg-white p-2 flex items-center ">
                        <div className="flex items-center gap-2 w-full h-full">
                            <Checkbox id="terms" className="rounded-none border-zinc-400 w-3.5 h-3.5 shadow-none data-[state=checked]:bg-zinc-900 data-[state=checked]:border-zinc-900" onClick={()=> setAcceptTerms(!acceptTerms)}/>
