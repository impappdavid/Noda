                ...
                <main className="flex flex-1 border-x border-zinc-300 h-full overflow-hidden bg-white pt-12.5">
                    ...
                    <div className="flex-[3] flex flex-col border-r border-zinc-300 h-full relative">
                        <header className="flex w-full items-center border-b border-zinc-300 bg-white sticky top-0 z-30 h-9 divide-x divide-zinc-300 shrink-0">
                            <button className="px-3 h-full hover:bg-zinc-100 transition-colors flex items-center gap-2 border-r border-zinc-300 group cursor-pointer outline-none">
                                <ArrowLeft size={12} />
                                <span className="text-xs font-mono text-zinc-500 uppercase tracking-widest">Return</span>
                            </button>
                            <div className="flex h-full pl-3 flex items-center w-full justify-between">
                                ...
                                <div className="flex items-center h-full">
                                    <button className="px-3 h-full hover:bg-zinc-100 transition-colors flex items-center gap-2 border-l border-zinc-300 group cursor-pointer outline-none">
                                        <Bookmark size={14} />
                                    </button>
                                    <button className="px-3 h-full hover:bg-zinc-100 transition-colors flex items-center gap-2 border-l border-zinc-300 group cursor-pointer outline-none">
                                        <Copy size={12} />
                        ...
                        <div className="flex-1 overflow-y-auto scrollbar-hide">
                            <div className="p-4">
                                ...
                                <div className="flex items-center gap-2 text-[11px] font-mono font-black uppercase tracking-widest text-zinc-400 mb-3">
                                    <span className="text-zinc-900">{JOB_MOCK_DATA.company}</span>
                                    <span className="opacity-50">•</span>
                                    <span className='text-zinc-500'>{JOB_MOCK_DATA.location}</span>
                                </div>

                                <div className="flex w-full border border-zinc-300 bg-white h-10 mb-4 shrink-0 divide-x divide-zinc-200">
                        ...
                        <button className="w-full bg-zinc-800 h-14 flex items-center justify-center gap-4 hover:bg-zinc-900 transition-all group shrink-0 border-none cursor-pointer">
                            <span className="text-xs font-semibold text-white uppercase tracking-[0.2em]">Apply now</span>
