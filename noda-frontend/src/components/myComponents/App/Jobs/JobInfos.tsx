...
const JobInfo = ({ job }: JobInfoProps) => {
    ...
    return (
        <div className="h-full flex flex-col bg-white overflow-hidden ">
            ...
            <div className="p-3 border-b border-zinc-300 bg-zinc-50/20">
                <div className="flex justify-between items-center mb-3">
                    ...
                    <div className="flex  bg-white ">
                        <button className="px-2 text-zinc-400 hover:text-zinc-900 hover:bg-zinc-200 cursor-pointer transition-colors">
                            <Share size={14} />
                        </button>
                        <button className="px-2 text-zinc-400 hover:text-zinc-900 hover:bg-zinc-200 cursor-pointer transition-colors">
                            <Bookmark size={14} />
                        </button>
                        <button className="px-2 py-2 text-zinc-400 hover:text-zinc-900 hover:bg-zinc-200 cursor-pointer transition-colors">
                ...
                <div className=" space-y-3">
                    <div className="flex items-center gap-3 p-3 border-b border-zinc-300">
                        ...
                        <span className="text-[10px] font-mono font-black text-zinc-500 uppercase tracking-widest">
                            Posted by <span className="text-zinc-900 hover:underline cursor-pointer">Marcus Vane</span> • 14 days ago
                        </span>
                    </div>

                    <div className="flex flex-col">
                        <section className="p-3">
                            <h4 className="text-[9px] font-mono font-black text-zinc-900 uppercase tracking-[0.3em] mb-3 flex items-center gap-3">
                                Role Specification
                                <div className="h-[1px] flex-1 bg-zinc-300"></div>
                            </h4>
                            <p className="text-[11px] text-zinc-700 leading-relaxed font-bold tracking-tight">
                                {job.description}
                            </p>
                        </section>
                        ...
                        <section className="p-3">
                            ...
                            <div className="flex flex-wrap gap-1">
                                {["React", "TypeScript", "Node.js", "System Design"].map((tag) => (
                                    <span key={tag} className="px-2 py-1 bg-zinc-50 border border-zinc-300 text-[8px] font-black text-zinc-500 uppercase tracking-widest">
                                        {tag}
                                    </span>
                                ))}
                            </div>
            ...
            <button className="w-full bg-zinc-800 h-12 flex items-center justify-center gap-3 hover:bg-zinc-900 transition-all group active:scale-[0.99] shrink-0 cursor-pointer">
...
const IntelligenceNode = ({ label, value, icon, protocolIcon }: any) => (
    <div className="flex flex-col items-center justify-center px-1 py-2">
        <div className={cn("flex items-center font-bold text-[10px] uppercase tracking-tight")}>
